...
\newcommand{\yourtitle}{On Practical Realization of Implicit Computational Complexity}
\newcommand{\yourname}{Neea Rusch}
\newcommand{\youradvisor}{Dr. Cl{\'{e}}ment Aubert}
\newcommand{\yourkeywords}{{programming languages}, {static program analysis}, {implicit computational complexity}, {verification}, {formal methods}}
\newcommand{\yourdate}{2025-01-01}
\togglefalse{ms}
