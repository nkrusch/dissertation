...
\lstinputlisting[language=C,nolol]{guide.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,nolol]{assign_expression.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,nolol]{exponent2_og.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,nolol]{notinfinite3.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,nolol]{infinite3.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,nolol]{dense_loop_og.c}
\end{minipage}
