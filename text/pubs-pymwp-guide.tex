...
pymwp\index{pymwp} (\enquote{pai m-w-p}) is a tool for automatically performing static analysis on programs written in a subset of the C language\index{C}\index{programming language!C}.
...
pymwp\index{pymwp} is an implementation demonstrating this technique concretely on C programs\index{C}\index{programming language!C}.
...
For a program written in C language\index{C}\index{programming language!C}, this property can be presented as follows.

\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[An imperative program that manipulates variables]An imperative program that manipulates numeric variables.}]{guide.c}
\end{minipage}

Question: \(\forall n\), is \(\texttt{X}_n \rightsquigarrow \texttt{X'}_n\) polynomially bounded in inputs?
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[Program \texttt{assign\_expression.c}]Program \texttt{assign\_expression.c}.}]{assign_expression.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[Program \texttt{exponent\_2.c}]Program \texttt{exponent\_2.c}.}]{exponent2_og.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[Program \texttt{notinfinite\_3.c}]Program \texttt{notinfinite\_3.c}.}]{notinfinite3.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[Program \texttt{infinite\_3.c}]Program \texttt{infinite\_3.c}.}]{infinite3.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
\lstinputlisting[language=C,caption={[Challenge program \texttt{dense\_loop.c}]A challenge program \texttt{dense\_loop.c}.}]{dense_loop_og.c}
\end{minipage}
...
\item \href{https://statycc.github.io/pymwp}{Documentation} -- Includes information about supported C language\index{C}\index{programming language!C} features, \etc
