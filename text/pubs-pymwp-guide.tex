...
\captionof{lstlisting}[Program assign\_expression.c]{\pr|assign\_expression.c|.}
\label{lst:assgn_exp}
\end{minipage}
\end{center}
...
\captionof{lstlisting}[Program exponent\_2.c]{\texttt{exponent\_2.c}.}
\label{lst:exponent2}
\end{minipage}
\end{center}
...
\captionof{lstlisting}[Program notinfinite\_3.c]{\texttt{notinfinite\_3.c}.}
...
\captionof{lstlisting}[Program infinite\_3.c]{\texttt{infinite\_3.c}.}
\label{lst:inifnite3}
\end{minipage}
\end{center}
...
\captionof{lstlisting}[Challenge program dense\_loop.c]{A challenge program dense\_loop.c.}
\label{lst:challange}
\end{minipage}
\end{center}
