...
%\item Given its paper proofs, is the theory correct? Can we prove formally the soundness of the flow calculus?
...
% pymwp: tacas (4) aplas (3) + (3) = 10 | fscd: aplas (3) fossacs (3) + (3) = 9 | vmcai: atva (4) + (3) = 7
...
% ni: fscd (4) + plas (2) | pc: ecoop (3)| coqpl: 4
