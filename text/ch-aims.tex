...
\langclr{ccstar}    & C*    & a generic imperative C-like language & / \\
...
\langclr{cmathc}    & ssreflect & the ssreflect language extension of Rocq & 2.3.0 \\
\bottomrule
...
in the style of the Z specification language\index{Z specification language} of~\textcite{spivey1992}.
