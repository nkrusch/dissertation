...
Consider a related comment about a letter-counting theorem:
\enquote{Although the classical formulation of Parikh’s Theorem concerns mainly the expressiveness of language models [\ldots] its usefulness in applications was enabled \textbf{only decades later} by the development of efficient algorithms [\ldots] These results enabled the exploitation of Parikh’s Theorem in many applications.}~\cite[pg. 2]{hague2024}}.
