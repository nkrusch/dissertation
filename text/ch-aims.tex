...
\item The \textbf{\hyperref[abs]{abstract}}: highlights only.
\item \textbf{Chapters~\ref{introduction}--\ref{ch:discussion} and~\ref{app:additional-manuscripts}}: the complete, full-length presentation.
\item \textbf{\autoref{ch:summary}}: a standalone, extended summary of the full presentation.
\end{enumerate}
\end{mdframed}
...
Documents that were not available online even at the time of writing this dissertation
are archived with the dissertation companion artifact (\autoref{tab:pub-artifacts}).
