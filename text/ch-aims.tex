...
\caption[Dissertation manuscripts]{Dissertation manuscripts. The manuscripts marked with $\ast$ are in review.}
...
\item Chapters~\ref{introduction}--\ref{ch:discussion} and \aref{additional-manuscripts} contain the full length presentation.
\end{itemize}

The options vary in detail and expected reading time (minutes, hours, days, \resp).
...
The \hyperref[sec:app:index]{Term Index} lists technical terms and their most relevant uses\footnote{
To keep the index helpful, not every term occurrence is indexed;
rather, the pages point to the most pertinent discussion about a particular term.}
...
\subsubsection{Archival of Nontraditional Bibliographic References}

Some bibliography entries refer to dynamic, non-publication resources like software, web pages, lecture notes, PDF files, \etc
To improve long-term availability of such bibliographic entries, these resources are archived in well-established online archives.
...
Documents that were not posted online even at the time of writing this dissertation are archived in the companion software artifact of this dissertation, \cf~\autoref{subsub:sw}.
