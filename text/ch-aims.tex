...
\item Broad insight is required to first identify suitable application domains, then to convert theories to applications.
A supporting case exists in automata theory, in Parikh's Theorem\footnote{
