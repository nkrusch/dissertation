...
invariants}~\cite{nguyen2017}. However, the solution relies on dynamic
...
\emph{Non-functional} properties\index{properties!non-functional} are concerned
...
formulated as follows. A \emph{\ndx{safety property}} is a guarantee that
\enquote{something (bad) will not happen}. A \emph{\ndx{liveness property}}
