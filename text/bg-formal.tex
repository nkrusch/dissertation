...
\begin{NiceTabularX}{\textwidth}{@{}l@{ }X@{}}
   ...
   {Gödel-Rosser Incompleteness Theorem}\index{Gödel-Rosser Incompleteness Theorem\dotfill}
   & \textcite{oconnor2005}
   \\
...
amortized resource analysis\index{automatic amortized resource analysis\dotfill}
