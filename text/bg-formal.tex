...
in~\autoref{fig:verification-approaches}.

\begin{figure}[ht]
\centering
\includegraphics[]{fig_fm-tools}
\caption[Formal verification approaches]{
Formal verification approaches -- adapted from~\textcite{leroy2018}.}
...
Mechanized proofs are created with theorem provers.
...
theory is not formalized mechanically. \ndx{Calf}~\cite{niu2022} (and its
extension \ndx{Decalf}~\cite{grodin2024}) is similarly a type system-based
approach. Calf embeds in types the amortized costs\index{amortization} of
