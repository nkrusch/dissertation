...
Verification-aware programming languages have built-in capabilities to express \ndx{specifications} and proofs.
...
Dafny was designed for reasoning, and it can automatically check programs against \ndx{specifications} during program development.
...
For verification tasks, the idea is to define \ndx{specifications} and write proofs aside the implementation, in \ndx{deductive verification}-style.
