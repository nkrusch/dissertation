...
&
    ...
    \href{https://satallaxprover.org}{Satallax}\index{Satallax},
...
\\
\midrule
\multicolumn{2}{@{}l}{\textbf{Language-based verification and modelling languages}} \\
&
    ...
    \href{https://kframework.org}{K Framework}\index{K Framework},
...
&
    ...
    \href{https://www.openjml.org}{OpenJML}\index{OpenJML}, %(Java),
    \href{https://github.com/viperproject/prusti-dev}{Prusti}\index{Prusti}, %(Rust),
    \href{https://github.com/epfl-lara/stainless}{Stainless}\index{Stainless}, %(Scala),
...
\hspace{1em}
    ...
    \href{https://github.com/asolarlez/sketch-frontend/wiki}{Sketch}\index{Sketch}
}
\\
\midrule
...
&
    \href{https://github.com/EasyCrypt/easycrypt}{EasyCrypt}\index{EasyCrypt} (cryptography),
    \href{https://iris-project.org/}{Iris}\index{Iris} (concurrency)
\\
\midrule
