...
\ndxl{Total correctness} can be viewed as a combination of safety\index{safety property} and liveness properties\index{liveness property}~\cite{lamport1977}.
...
\footnote{\ndxl{Total correctness} is not always ideal.
