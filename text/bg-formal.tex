...
\caption[Overview of Dafny implementation and workflow]{Overview of Dafny implementation and workflow.
...
A small green check means the verifier succeeds at the proof obligation of the corresponding line.
A big green check indicates success with the full construct.
The verification fails on the declarations that are marked with a red block.
The big red \circled{X} marks constructs that fail to verify (even if some declarations succeed).}
\label{fig:dafny-use}
\end{figure}
