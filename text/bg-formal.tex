...
There exists a (small) collection of result formalizing classic complexity theory (\cf~\autoref{subsec:coqpl-related}).
For example, \ndx{Universal Turing Machine}s~\cite{forster2020}, the \(\mathcal{O}\)-notation\symbo{bigo}~\cite{gueneau2018},
and the \ndx{Cook-Levin theorem}~\cite{gaher2021}%! suppress = CollapseCite
\footnote{The Cook-Levin theorem states that Boolean SAT is NP\ccxi{np}-Complete~\cite{cook1971, levin1973}.}
