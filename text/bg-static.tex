...
\begin{figure}[h]
\centering
\includegraphics[width=.9\textwidth,keepaspectratio]{fig_bugverify}
...
\item \href{https://costa.fdi.ucm.es/~costa/pubs/pubs.php}{{PUBS}: Practical Upper Bounds Solver}\index{PUBS}~\cite{albert2010}
...
\item \href{https://aprove.informatik.rwth-aachen.de}{{AProVE}}\index{AProVE}~\cite{giesl2017}
...
\item \href{https://www-sop.inria.fr/members/Martin.Avanzini/software/eco-imp/}%
      {\emph{Eco-Imp}\index{eco-imp}}~\cite{avanzini2020}
      computes expected cost bounds for programs written in a probabilistic imperative \textsc{pWhile} language.

\item \href{https://gitlab.inria.fr/complexityparser/complexityparser/-/tree/master}{{ComplexityParser}\index{ComplexityParser}}~\cite{hainry2021}
...
\item \href{https://github.com/statycc/pymwp}{{pymwp}\index{pymwp}}~\cite{aubert2023b}
