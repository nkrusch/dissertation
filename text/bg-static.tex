...
abstract interpretation~\cite{cousot2021}\index{abstract interpretation};
...
Informally, Rice's theorem asserts that all interesting questions about the input/output behavior of programs written in a Turing-complete\index{Turing-completeness} language are undecidable.}, it is impossible to construct a perfect program analyzer for a Turing-complete language.
...
\paragraph*{Automatic amortized resource analysis.}\index{automatic amortized resource analysis}
