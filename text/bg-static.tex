...
amortized\index{amortization} resource analysis (AARA) and \ndx{cost equation
system}s (CES). These techniques are briefly introduced next.

\paragraph*{Automatic amortized resource analysis.}
\index{automatic amortized resource analysis}
Amortized analysis\index{amortization} averages the time required to perform a
...
analysis\index{amortization}. This adds the ability to account for amortization
