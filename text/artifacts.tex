...
\begin{tabular}{lllcc}
\toprule
\textbf{\prc|\#|} & \textbf{Year} & \textbf{Description} & \textbf{Badges}  & \textbf{Version} \\
\midrule
1. & 2022 & \textbf{pymwp} && 0.1.6 \\
&& \multicolumn{3}{l}{\textit{Companion artifact for \aref{app:sec:fscd}}} \\
&& \multicolumn{3}{l}{
...
&& \multicolumn{3}{l}{Repository: \swlink{https://github.com/statycc/pymwp/releases/tag/FSCD22}{statycc/pymwp/releases/tag/FSCD22}} \\
\midrule
2. & 2022 & \textbf{Loop fission evaluation}  &
\multirow{2}{*}{
\begin{tabular}{c}
\includegraphics[height=1cm,keepaspectratio]{pictures/available} \\
...
\midrule
5. & 2025 & \textbf{Dissertation companion artifact} && 1.0.0 \\
