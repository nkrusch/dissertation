...
A repository address is not included if the development is still private.
...
3.  & \textbf{Formalization of the flow calculus of mwp-bounds} \\
    ...
    & The artifact aims to formalizes the paper proofs from~\textcite{jones2009}, to prove the soundness theorem (\autoref{mwp-soundness}) of the mwp-calculus. \\
\midrule
\end{NiceTabularX}
