...
The \emph{degree} of choice, \(k : \mathbb{N}\)\symbo{k2}\symbo{nat}, is a counter of derivations.
...
\begin{definition}[Derivation choice]
    Letting \( \mathcal{D} \) be a domain and \( k \in \mathbb{N} \)\symbo{nat} be the degree of choice,
...
\begin{definition}[Choice vector]
    Letting \( \mathcal{D} \) be a domain and \( k \in \mathbb{N} \)\symbo{nat} be a choice degree,
