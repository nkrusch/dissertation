...
\includepdf[pages={1-},
    ...
    addtolist={
        ...
        12,algorithm,{A loop fission algorithm},alg:loop-fission,
    ...
    \addtoindexm{OpenMP directives!\texttt{nowait}}{17}
    \addtoindexm{OpenMP directives!\texttt{parallel}}{5,15,16,17}
    \addtoindexm{OpenMP directives!\texttt{pragma omp}}{17}
    \addtoindexm{OpenMP directives!\texttt{private}}{17}
    \addtoindexm{OpenMP directives!\texttt{single}}{17,18}
    ...
    \addtoindexm{compiler!ROSE}{14,15,16,17,18,9,20}
