...
usefulness in cryptographic proofs\index{cryptography}~\cite{heraud2011}. When
...
\ndx{EasyCrypt}~\cite{barthe2014}. The support for complexity proofs in
EasyCrypt is limited~\cite{barbosa2023}. Thus, the integration of safe
recursion did not survive the \enquote{test of time}.
