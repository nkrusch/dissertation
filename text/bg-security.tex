...
\infer0[]{{\color{red}{\text{\circled{\normalfont{\texttt{X}}}}}} \vdash \prm{v}₂\prm{:=e}₂}
...
The derivation gets stuck at point marked{ }{ }{\color{red}{\circled{\normalfont{\texttt{X}}}}}{ }because the program has a non-interference\index{non-interference} violation.
...
The type system d\(\ell\)T~\cite{baillot2015,baillot2019}\index{d\(\ell\)T} is both complexity-aware and has capabilities to support cryptographic proofs\index{cryptography}.
