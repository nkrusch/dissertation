...
The idea to use programming languages to model {non-interference\index{non-interference}} was introduced by~\textcite{volpano1996}.
...
Since the programs are written in Java\index{Java}, the constructs are richer than available in the type system \ndx{grammar}.
...
We map the program to the \ndx{grammar} by substituting \pr|h > 0| with \pr|e|₀ and \pr|h--| with \pr|v:=e|₁\footnote{
