...
As a technique, it is a refinement of prior works (refer to~\autoref{sec:vmcai} and~\cite{moyen20172}) where it was used for compile-time program optimization.
