...
A separate series of works applies implicit computation complexity toward applications in the security domain.

\begin{description}

\item[formalized safe recursion.]
The formalization of \ndx{safe recursion} (\cf~\autoref{safe-rec}) was primarily motivated by its envisioned usefulness in cryptography~\cite{heraud2011}.
