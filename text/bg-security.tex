...
\infer0[]{{\color{red}{\text{\circled{\texttt{X}}}}} \vdash \prm{v}₂\prm{:=e}₂}
...
The derivation gets stuck at point marked{ }{\color{red}{\circled{\texttt{X}}}}{ }because the program has a non-interference\index{non-interference} violation.
