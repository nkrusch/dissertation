...
\textsc{input}
  & Language & \(\mathcal{L}\) (baseline)\smtabularnote{The language is similar to IMP in~\textcite[p. 11--26]{winskel1993} and~\textcite{cpierce20221}.} & \(\mathcal{L} + f +\) recursion & \(\mathcal{L} \mapsto \) C99 & loops \(\subset \mathcal{L}\) \\
\midrule
\textsc{procedure}
