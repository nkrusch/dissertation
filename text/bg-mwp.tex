...
\lstinputlisting[language=IMP,caption={A derivable program.},label={lst:ex-derivable}]{derivable.c}
...
%! suppress = FileNotFound
\lstinputlisting[language=IMP,caption={A loop that always fails the derivation.},label={lst:ex-failing}]{failing.c}
...
%! suppress = FileNotFound
\lstinputlisting[language=C,caption={A program with a single assignment.},label={lst:ex-assign}]{assign_expression.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
%! suppress = FileNotFound
\lstinputlisting[language=C,caption={A program with exponential variable value growth.},label={lst:ex-exponent2}]{exponent2.c}
\end{minipage}
...
%! suppress = FileNotFound
\lstinputlisting[
language=C,caption={A program with a \pr|while| loop.},label={lst:notinfinite3}]{notinfinite3.c}
\end{minipage}
...
\begin{minipage}{\textwidth}
%! suppress = FileNotFound
\lstinputlisting[language=C,caption={An \enquote{infinite} program.},label={lst:ex-infinite3}]{infinite3.c}
\end{minipage}
...
caption={A challenge program whose derivability is unknown.},
