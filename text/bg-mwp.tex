...
\textit{\ndx{honest polynomials}}, build up from constants and variables by
...
\captionof{lstlisting}[Program with arithmetic, transformed]{Transformed program with arithmetic (\(\mathsf{P_A}\)).}
