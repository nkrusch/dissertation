...
\lstinputlisting[language=C,label={lst:canonical},caption={[Canonical loop form]Canonical loop form.}]{canonical.imp}
\end{minipage}
\end{center}
...
\cstarinputlisting[][emph={X},emphstyle={\color{pthread}\textbf},numbers=none]{dep-true.imp}
\captionof{lstlisting}[True dependence]{True dependence.}
\label{dep-true}
\end{minipage}\hspace{3em}
\begin{minipage}[t]{.4\textwidth}
\cstarinputlisting[][emph={X},emphstyle={\color{pthread}\textbf},numbers=none]{dep-anti.imp}
\captionof{lstlisting}[Antidependence]{Antidependence.}
\label{dep-anti}
\end{minipage}

\begin{minipage}[t]{.4\textwidth}
\cstarinputlisting[][emph={X},emphstyle={\color{pthread}\textbf},numbers=none]{dep-out.imp}
\captionof{lstlisting}[Output dependence]{Output dependence.}
\label{dep-out}
\end{minipage}\hspace{3em}
\begin{minipage}[t]{.4\textwidth}
\cstarinputlisting[][emph={X},emphstyle={\color{pthread}\textbf},numbers=none]{dep-control.imp}
...
\cstarinputlisting{loop-carried.c}
\end{minipage}\hfill%
...
\draw[black,arrows={-Latex[width=5pt, length=4pt, fill=white]}] (6,.65) -- (6.5,.65) node[right,xshift=5pt] {\small\circled{\texttt{S1}}};
\end{tikzpicture}
\end{minipage}
...
\begin{minipage}{.45\textwidth}
\hfill\begin{tikzpicture}
\draw[rectangle, draw=black, fill=tgrey] (0,0) rectangle (5.9,1.5);
\draw[thread,pthread] (2.95,1.5) -- (2.95,0);
\node[above] at (2.95,1.5) {thread 0};
\end{tikzpicture}
\end{minipage}
...
\begin{minipage}{.45\textwidth}
\hfill\begin{tikzpicture}
\draw[rectangle,draw=black,fill=tgrey] (0.0,0) rectangle (5.9,1.5);
\draw[thread,pthread]
              (2.50,1.5) -- (2.50,0);
\draw[thread] (2.83,1.5) -- (2.83,0);
\draw[thread] (3.17,1.5) -- (3.17,0);
\draw[thread] (3.50,1.5) -- (3.50,0);
\node[above] at (2.50, 1.5) {0};
\node[above] at (2.83, 1.5) {1};
\node[above] at (3.17, 1.5) {2};
\node[above] at (3.50, 1.5) {3};
...
\hfill\begin{tikzpicture}
\draw[rectangle,draw=black,fill=tgrey] (0.0,0) rectangle (5.9,1.5);
\draw[black, thick, densely dotted] (1.5,0) -- (1.5,1.5);
\draw[black, thick, densely dotted] (3.0,0) -- (3.0,1.5);
\draw[black, thick, densely dotted] (4.5,0) -- (4.5,1.5);
\draw[thread,pthread] (0.7,1.5) -- (0.7,0);
\draw[thread] (2.3,1.5) -- (2.3,0);
\draw[thread] (3.8,1.5) -- (3.8,0);
\draw[thread] (5.3,1.5) -- (5.3,0);
\node[above] at (0.7, 1.5) {0};
\node[above] at (2.3, 1.5) {1};
\node[above] at (3.8, 1.5) {2};
\node[above] at (5.3, 1.5) {3};
\draw[thick,line width=.5mm] (0,0) -- (5.9,0) ;
\end{tikzpicture}
\end{minipage}
