...
\subsection{Preliminary Action Plan}  % Replace with a better title
\label{sec:plans}
...
We chose this method because its internal mechanics has been recently studied~\cite{aubert20221}, and by our assessment, it seems suitable for formalization in Coq.
...
We leave for future work the possibility of creating a formally verified, automatic static analyzer founded on the proof of correctness of this method: as we discussed in other works~\cite{aubert2023b,aubert20221}, care is required to implement a typing strategy that does not rapidly become intractable.
