...
In practice, \ndx{security type system}s are challenging to use because they modify the programming language.
...
The DCC is an extension of lambda-calculus\index{\(\lambda\)-calculus}, framed around the notion of data dependency, of which \ndx{non-interference} is an instance.
