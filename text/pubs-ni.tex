...
\end{align*}\symbo{bnfsep}\symbo{coloneqq}
...
When \ndx{security classes} of variables are known partially, it is possible to
...
similarly rooted in \ndx{dependency analysis} \lname originates from works of
implicit computational complexity (ICC). It is a refinement
...
\end{center}
and the derivation (\(\pi_2\)\symbo{smpi}) of command{ }{ }\circled{C2} is
\begin{center}
%! suppress = EscapeAmpersand
\begin{prooftree}[small]
\infer0[Asgn]{\prc|z==1|:
