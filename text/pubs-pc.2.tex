...
\begin{figure}[H]
\centering
\scalebox{.8}{\begin{tikzpicture}[align=center,
...
The flow coefficients are elements of the finite set \(\text{\textsc{mwp}}^\infty \triangleeq \{0, m, w, p,\infty\}\).
A \emph{domain} \(\mathcal{D} \triangleeq \{0, 1, 2 \}\) is a bidirectional map of the flow calculus inference rules.
