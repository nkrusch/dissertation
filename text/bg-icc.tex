...
The limitations are that a \ndx{size bound} has to be proved on the semantics of recursion, and the proof uses a particular model of \ndx{Turing Machine}.
...
Note that Safe recursion aims to guarantee that there exists a polynomial bounding the execution time; however, it does not provide
the actual value of the polynomial (\ie the \ndx{complexity bound} are implicit)~\textcite{heraud2011}.
...
\begin{tabularx}{\textwidth}{@{}lclX@{}r@{}}
    ...
    \midrule
    2011 & \types & LICS & \ndx{SAFE programs} -- \autoref{icc-sec} & \ccx{p} \\*
    &&& \textcite{marion2011} \\*
    \midrule
    ...
    &&& \textcite{baillot2015} \\*
    \midrule
    2016 & \logics & Inf. Comput. & Complexity with \ndx{pointer machines} & \ccx{l} \\*
    &&& \textcite{aubert2016}  \\*
    \midrule
    2016 & \recs & Inf. Comput. & Complexity of uniform \ndx{Boolean circuits} & \ccx{nc} \\*
    ...
    &&& \textcite{hainry2023} \\*
    \midrule
    2024 & \types & POPL & Quantitative type theory with \ndx{dependent types}\index{quantitative type theory} & \ccx{p}, \ccx{np}, \ccx{bpp} \\*
    &&& \textcite{atkey2024} \\*
    \midrule
