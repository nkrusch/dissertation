...
\begin{tabularx}{\textwidth}{@{}lclXr@{}}
    ...
    \midrule
    2001 & \dataflow & POPL & \multicolumn{2}{l@{}}{
        Size-change termination principle\index{size-change termination principle} -- \autoref{resource-analysis}\hfill\ccx{pspace}} \\*
    &&& \textcite{lee2001} \\*
    \midrule
