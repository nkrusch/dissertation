...
classes}\index{complexity class}. The classes describe resource requirements
...
classes\index{complexity class} and yields more natural definitions and proofs
