...
\subsection{Seeking Strong Software Quality Guarantees}
...
{seems like} a good candidate for \ndx{automatic resource analysis}.
...
loop\index{loop transformations}, such that post-transformation the program
...
For RQ1, we enhanced the theory to develop an \ndx{automatic resource analysis}
...
\paragraph*{On \ndx{automatic resource analysis}} We can now confirm that it is
