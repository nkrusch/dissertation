...
\chapter{Unpublished Research}\label{ch:unpublished-research}
    ...
    Workshop on Coq for Programming Languages (CoqPL)} 2023.}
    \clearpage
...
\chapter{Summary}\label{ch:summary}
    ...
    \label{sec:absext}
    \ainfo{Neea Rusch}
    {\emph{Symposium paper.}
    \newline\newline{}The summary was presented at the
    \href{https://2025.ecoop.org/track/ecoop-2025-doctoral-symposium}
    {Doctoral Symposium} of the European Conference on
