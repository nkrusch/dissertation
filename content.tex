...
\chapter{Unpublished Research}\label{ch:unpublished-research}
    ...
    \clearpage
    {\input{latex/niprc}\input{text/pubs-ni}}
    \clearpage
    ...
    \newline\newline{}The workshop paper by~\text{aubert20231} was presented at
...
\clearpage
    ...
    This extended abstract summarizes the full-length chapters in a
    standalone way.
