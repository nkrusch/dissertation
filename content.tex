...
\newline\newline The publication~\cite{aubert2023b} is reproduced with permission from Springer Nature.}
...
\addtoindex{NP complexity class}{6}
\addtoindex{P complexity class}{3}
...
\newline\newline The publication~\cite{aubert20232} is reproduced with permission from Springer Nature.}
...
\chapter{Tool User Guide for \enquote{pymwp: A Static Analyzer Determining Polynomial Growth Bounds}}\label{app:toolguide}
