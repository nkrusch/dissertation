...
\chapter{Unpublished Research}\label{ch:unpublished-research}
    ...
    \pageIconSecurity
    \ainfo{Clément Aubert and Neea Rusch}{Draft conference research paper}\clearpage
    ...
    \pageIconFm
    \ainfo{\CTNT}
    {A workshop paper that appeared at the \href{https://popl23.sigplan.org/home/CoqPL-2023}
    {Ninth International Workshop on Coq for Programming Languages (CoqPL), 2023}}
    \clearpage\input{text/pubs-coqpl}
    \clearpage
