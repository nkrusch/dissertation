...
\documentclass[letterpaper,12pt,bibliography=leveldown]{scrreprt}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand\ETDTITLE{Some Title}
\newcommand\ETDAUTHOR{Neea Rusch}
\newcommand\ETDADVISOR{Dr. Cl{\'{e}}ment Aubert}
\newcommand\AWESOMEFOURSOME{Cl{\'{e}}ment Aubert, Thomas Rubiano, \ETDAUTHOR, Thomas Seiller}
...
% title page, acknowledgement page, abstract, table of contents.
\thispagestyle{empty}\maketitle\clearpage
\thispagestyle{empty}\input{text/_acks}\clearpage
\thispagestyle{empty}\input{text/_abstract}\clearpage
...
\ainfoX{\AWESOMEFOURSOME}{\href{https://atva-conference.org/2023}
...
\includepdf[pages={1-},scale=0.9,offset=0 0.25in]{res/pubs_pymwp_guide.pdf}
