...
twoside=false, bindingoffset=0pt, nohead%
%,showframe
]{geometry}
...
\renewcommand{\yourdate}{%
    \DTMenglishmonthname{\@dtm@month}\iftoggle{hal}{ }{\\}\@dtm@year
}
\makeatother
...
\iftoggle{hal}{\\}{\vspace{1em}\par}
}{}{}
\iftoggle{hal}{\appto{\yourdate}{\vspace{1em}\par\committee\vspace{2em}\par}}{}
\makeatother
...
\addtokomafont{author}{\iftoggle{hal}{\large}{\Large}}
% Date should be in smaller font.
\setkomafont{date}{\iftoggle{hal}{\normalsize}{\large}}
