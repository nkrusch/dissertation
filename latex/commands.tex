...
\newtcolorbox{infobox}[1][]{
    ...
    sharp corners=all,
    finish={
        \node[rectangle, fill=white, draw=paper, solid, align=center,
        line width=1.5pt, text width=8pt, inner sep=4pt, outer sep=0.4pt,
        xshift=-2mm, yshift=-3mm, anchor=north west]
        at (frame.north west) {\textnormal{\scalebox{.65}{\faExclamation}}};
    },#1
}