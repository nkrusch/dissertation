...
% Document commands
\newcommand{\aref}[1]{\hyperref[#1]{\autoref*{#1}}}
...
\newcommand{\ndx}[1]{#1\index{#1}}
\newcommand{\ltac}[1]{\pr|#1|\index{Rocq tactics!{#1}}}
...
\newcommand\Hoare[3]{\{\,#1\,\}\mathrel{#2}\nolinebreak\{\,#3\,\}} % hoare triple
...
% postconditions
\newcommand{\impl}{mwp$_\ell$\xspace}
\newcommand{\impf}{mwp$_f$\xspace}
...
\newtcolorbox{infobox}[2][]{
    ...
    % sharp corners=all,
    rounded corners=all,
    before upper={\textbf{#2.}{ }},
    finish={
    \node[circle, fill=white, draw=important, solid, align=center,
        line width=1pt, inner sep=1.5pt, outer sep=0.4pt, rounded corners=2pt,
        xshift=-3mm, yshift=1.5mm, anchor=north west]
        at (frame.north east) { \iconIMP };
    },#1
}