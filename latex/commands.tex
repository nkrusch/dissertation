...
\newcommand{\lname}{\ndx{\(\top^{\ast}_{\textsc{ni}}\)}\@\xspace} % change it if you don't like it
\newcommand{\tool}{\textsc{tyni}\index{tyni}\@\xspace}
...
\newtcolorbox{infobox}[2][]{
    ...
    detach title,
    rounded corners=all,
    before upper={\iconIMP\hspace{.4em}\textbf{#2.}\hspace{.75em}},
    finish={ }, #1
}
\newcommand{\goal}[1]{\iconBOX{ }\textbf{G#1.}}
