...
\newcommand{\langclr}[1]{\tikz{\node[rectangle,minimum size=3mm,rounded corners=3pt,fill=#1]{};}}
...
% multi index-add
\setsepchar{,}
\newcommand{\addtoindexm}[2]{
\readlist\ipages{#2}
\foreachitem\word\in\ipages{\addtoindex{#1}{\word}}}
% multi symbols-add
\newcommand{\addtosymbolsm}[2]{
\readlist\ipages{#2}
