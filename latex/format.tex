...
\newglossarystyle{longraggeddots}{
    ...
    \renewcommand{\glsentryname}{% for 1st child entry
        \parindent-5pt% left margin to child name
        \par% newline
        \hangindent0pt% left margin to paragraph margin
...
% tables, lists, graphs, charts.
% Single-space: footnotes/endnotes, bibliographic entries, lists in appendices.
% ---
% I have read the above, but the alternation hurts, so I refuse to follow it.
% ---
