...
\newcommand{\iconIMP}{\textnormal{\raisebox{0.15\height}{\scalebox{.75}{\faStarOfLife}}}} % important
\newcommand{\iconBOX}{\textnormal{\raisebox{0\height}{\scalebox{.90}{\faSquare[regular]}}}} % checkbox
...
\newcommand{\circledc}[2][black]{\hspace{.1ex}\raisebox{-0.2\height}{\scalebox{.6}{%
    \tikz{\node[font={\selectfont\color{#1}},
        circle,inner sep=2pt,outer sep=.4pt,fill=white,
        draw=#1,solid,thick]{\textbf{#2}};}}}}
