...
\lstdefinelanguage{ces}{ %cost equation system
...
\NewDocumentCommand{\newlang}{o m m m m m}{%
    ...
    \expandafter\NewDocumentCommand\csname \n listing\endcsname{s O{} O{}}{%
        \def\WithoutTitle{\tcblisting{
            ...
            style=solarized-light,backgroundcolor=\color{#5},#6},
            ##2
        }}%
...
\newlang[cmd]{text}{cmd}{sbase01}{consolebg}{numbers=none,prebreak={}}
\newlang[c]{C}{C}{sblue}{sbase3}{}
\newlang[cstar]{C}{C*}{sviolet}{sbase3}{}
\newlang[ompcode]{OpenMP}{omp}{scyan}{sbase3}{}
\newlang[imp]{IMP}{imp}{sgreen}{sbase3}{}
\newlang[ces]{ces}{CES}{sgreen}{sbase3}{}
\newlang[coq]{Coq}{coq}{scoral}{sbase3}{escapeinside={}}
\newlang[dafny]{Dafny}{\color{sbase03}{Dafny}}{dyellow}{sbase3}{escapeinside={}}
\newlang[java]{Java}{Java}{sgreen}{sbase3}{}