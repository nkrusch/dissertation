...
\lstset{
    columns=fixed,
    basicstyle=\small\color{sbase03}\ttfamily\textnormal\linespread{4},
...
\lstdefinestyle{solarized-light}{
    ...
    basicstyle=\color{sbase03}\ttfamily\textnormal\lst@ifdisplaystyle\small\fi,
...
\newlang[cmd]{text}{cmd}{sbase01}{consolebg}{numbers=none}
