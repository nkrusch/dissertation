...
\tikzstyle{arrowB} = [black,arrows={-Triangle}]
\tikzstyle{arrowW} = [black,arrows={-Triangle[black,fill=white]}]
...
\foreach \x in {0,...,\n} {
  \draw[box] (\w*\x+.5,0.5) rectangle node[below=.5cm, midway] (\x) {\x} ++(\w,+0.5) ; 
