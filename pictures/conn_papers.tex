...
\tikzstyle{start} = [
	rectangle, rounded corners=0pt, line width=1.5pt, minimum height=2cm,
...
\node (mwp) [prior, below of=icc, xshift=-3.75cm] {\authT{A Flow Calculus of mwp-Bounds\\for Complexity Analysis}{\authA (2009)}};
\node (qsi) [prior, right of=mwp, xshift=4.75cm] {\authT{Loop Quasi-Invariant Chunk Detection}{\authC (2017)}};
...
%\node [topic label, below of=SL, yshift=50pt, xshift=-13pt] {$^*$ \emph{in review or near submission}};
...
\fill[draw=paper, thick, fill=paperbase, solid] (8, 12) circle (.75ex) node[right, xshift=3mm]{Dissertation work};
