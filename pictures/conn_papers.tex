...
\tikzstyle{start} = [rectangle, 
  ...
  densely dashed,
  fill=concept]
\tikzstyle{prior} = [start, solid, fill=prior]
\tikzstyle{node} = [prior, fill=paper]
\tikzstyle{arrow} = [thick,->,>=stealth]
\tikzstyle{rectangle connector} = [-latex, thick, pos=0.5, to path={(\tikztostart) -- ++(#1,0pt) \tikztonodes |- (\tikztotarget)}]
\tikzstyle{topic icon} = [rectangle, text width=.5cm, yshift=2.3cm]
\tikzstyle{topic label} = [rectangle, text width=5cm]
...
\begin{tikzpicture}[node distance=3cm,
    ...
    append after command={
    	node[circle, fill=paper!20!white, draw=black, solid,
