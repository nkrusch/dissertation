...
%node[matrix,anchor=north west,cells={nodes={font=\footnotesize,anchor=west}},
%draw,thick,inner sep=1ex]{
%    \draw[-latex,medge](0,0) -- ++ (0.6,0); & \node{maximally linear};\\
%    \draw[-latex,wedge](0,0) -- ++ (0.6,0); & \node{weak polynomial};\\
%    \draw[-latex,pedge](0,0) -- ++ (0.6,0); & \node{polynomial};\\
%    \draw[-latex,iedge](0,0) -- ++ (0.6,0); & \node{failure};\\
%};