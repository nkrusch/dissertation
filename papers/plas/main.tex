% Website: https://plas24.github.io/
% Submit: https://hotcrp.software.imdea.org/plas24/
% Paper submission: June 20, 2024
% Author notification: August 8, 2024
% Workshop date: October 14, 2024
% Note: even if I don't like it, I've picked IEEEtran because that's the style we'll use if we submit to CSF :-)
\RequirePackage{etex}
...
\renewcommand*{\bibfont}{\footnotesize} % see: https://tex.stackexchange.com/q/386709

\usepackage{utfsym} % Required for \usym{1F322}
\newcommand{\vi}{\usym{1F322}} % Command for "leak" / "violation"=> 💧 in unicode?
...
\author{
	\IEEEauthorblockN{Clément Aubert}
	\IEEEauthorblockA{%
		Augusta University \\
		Augusta, GA, USA\\
		\href{mailto:caubert@augusta.edu}{caubert@augusta.edu},
		\href{https://orcid.org/0000-0001-6346-3043}{ORCID}
	}
\and
	\IEEEauthorblockN{Neea Rusch}
		\IEEEauthorblockA{%
		Augusta University \\
		Augusta, GA, USA\\
		\href{mailto:caubert@augusta.edu}{nrusch@augusta.edu},
		\href{https://orcid.org/0000-0002-7354-5330}{ORCID}
	}
}
...
\section{Illustrative Derivations}
\label{sec:examples}
