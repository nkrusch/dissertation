...
% ICC offers a way.
The field of Implicit Computational Complexity (ICC)~\cite{dallago2011}\index{ICC} drives better understanding of complexity classes, but it
...
The \emph{mwp}-flow analysis\index{mwp-calculus} certifies polynomial bounds on the size of the values manipulated by
...
The Mathematical Components library~\cite{mahboubi2022}\index{mathcomp} will lay the foundations for the linear algebra representations,
...
following the examples from Software Foundations~\cite{cpierce20221,cpierce20222}\index{Software Foundations}.
